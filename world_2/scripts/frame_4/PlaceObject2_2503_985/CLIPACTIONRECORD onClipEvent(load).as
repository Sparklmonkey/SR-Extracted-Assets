   ...
   checkFct = function()
   {
      ...
      root.battleSystem.CallbackEndBattle = function(battleResult, ptsVictory)
      {
         ...
         if(battleResult)
         {
            ...
            root.textWindow.drawWindow([root.getInsName("txt_ev_collect1",root.parseKitWorld) + "1" + root.getInsName("txt_ev5_item",root.parseKitWorld) + root.getInsName("txt_ev_collect2",root.parseKitWorld)],0,root.textWindow.closeWindow);
         }
         else
         {
