onClipEvent(load){
   ...
   newObj.fct = function()
   {
      ...
      if(someItem == "monacle")
      {
         root.textWindow.drawWindow([root.getInsName("txtM7Z1_p1",root.parseKitMissions)],30,endFct);
      }
      if(someItem == "spiderItem")
      {
         root.textWindow.drawWindow([root.getInsName("txtM7Z1_p2",root.parseKitMissions)],30,endFct);
      }
   };
   fct = function(item)
   {
