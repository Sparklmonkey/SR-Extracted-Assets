class admin.general.infoAlert extends UI.core.movieclip
{
   function infoAlert()
   {
      super();
      ...
      this.attachMovie("info_ico","eIco",2);
      this.attachMovie("infoClose","cBtn",3);
   ...
   function killMsg()
   {
      ...
      {
         _global.am.onClose(1);
         _global.am.regError2 = false;
         _global.am.tray.removeItem("iID");
      }
      this._parent.repositionItem(1);
   }
   function clear()
   {
      this.nav.clear();
   ...
   function redraw(w, h)
   {
      ...
      this.UISpace.clear();
      this.drawRect(this.UISpace,0,1,w + 1,h,0,30,5);
      this.UISpace.endFill();
      var _loc4_ = [5270136,5402490];
      var _loc2_ = [100,100];
      var _loc7_ = [0,255];
      var _loc10_ = w / 4 * 2;
