class admin.Panels.Servers.Forms.Form_RestartVHost extends UI.core.Form
{
   function Form_RestartVHost()
   {
      super();
      this.addControl("Label","l1",0,{text:"Are you sure you want to restart this vhost?",width:250,height:20,_x:20,_y:20});
