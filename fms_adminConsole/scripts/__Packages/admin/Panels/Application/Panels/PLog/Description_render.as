class admin.Panels.Application.Panels.PLog.Description_render extends UI.core.movieclip
{
   ...
   function select(s, e)
   {
      ...
      this.label.htmlText = this.strPre + _loc2_.slice(0,s) + "<b><u>" + _loc2_.slice(s,e) + "</u></b>" + _loc2_.slice(e,_loc2_.length) + this.strEnd;
   }
